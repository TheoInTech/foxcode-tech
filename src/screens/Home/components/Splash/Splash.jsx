                    ...
                    <Container fluid>
                        <Row className="align-items-center">
                            <Col lg="6" xs="12" className="splash__statement">
                                ...
                                <Form className="splash__statement__form" onSubmit={this.getAppointment} data-netlify="true" name="formSplash" id="formSplash" method="POST" enctype="application/x-www-form-urlencoded" action="/">
                                    <Form.Row>
                                        <Col lg="7" sm="12">
