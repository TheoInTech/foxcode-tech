        ...
        this.services = [
            {
                ...
                description: 'Drive more customers to your business and let the world know about how great your products and services are.'
            },
            {
                img: '/images/logo-design.svg',
                title: 'Logo & Creatives Design',
                description: 'Showcase your brand and never worry about producing outdated design trends.'
            },
            {
                img: '/images/marketing.svg',
                title: 'Digital Marketing',
                description: 'Advertise your services and products with our professional digital marketers.'
            },
            {
                img: '/images/technical-consultation.svg',
                title: 'Consultation',
                description: 'Practical analysis of technical and/or marketing techniques that will optimize value, productivity and efficiency.'
            },
            {
                img: '/images/seo.svg',
                title: 'SEO & API Integration',
                description: 'Be on top of search engine results and integrate those to analytical data reporting.'
            }
        ];
                ...
                <section className="services" id="services">
                    <Container fluid>
                                            ...
                                            <Card className="services__card" onClick>
                                                <Card.Body className="services__card__body">
                                                    <div className="services__card__body__image">
                                                        <Image src={service.img} alt="Web Development" title="Web Development" width="220" />
                                                    </div>
                                                    <h3 className="services__card__body__title">{service.title}</h3>
                        ...
                        <Row className="justify-content-center services__statement">
                            <Col lg="6" xs="12">
                                <Form onSubmit={this.getAppointment} data-netlify="true" name="formServices" id="formServices" method="POST" enctype="application/x-www-form-urlencoded" netlify-recaptcha>
                                    <Form.Row>
                                        <Col lg="8" sm="12">
                                            <Form.Control type="text" name="serviceContact" placeholder="Email address / Phone number" className="services__statement__form__input" required />
                                        </Col>
                                        <Col lg="4" sm="12">
                                        <FCButton type="submit" name="serviceButton" className="services__statement__button">Get Quote</FCButton>
                                        </Col>
                                    </Form.Row>
                                </Form>
                            </Col>
