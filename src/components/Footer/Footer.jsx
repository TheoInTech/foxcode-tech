                        ...
                        <Row>
                            <Col lg="3" sm="12" className="footer__top__info">
                                <div className="footer__top__info__logo">
                                    <a href="/"><Image src="/logo.png" alt="Fox Code" width="80" /></a>
                                </div>
                                ...
                                <div className="footer__top__info__content">
                                    <div className="footer__top__info__content__item media">
                                        <div className="footer__top__info__content__item media__image">
                                            <Image src="/images/web-development.svg" alt="Web" width="100%" />
                                        </div>
                                        <div className="footer__top__info__content__item media__title">
                                            <h5><a href="#services">Web Development</a></h5>
                                            <p>Drive more customers to your business and let the world know about it.</p>
                                        </div>
                                    </div>
                                    <div className="footer__top__info__content__item media">
                                        <div className="footer__top__info__content__item media__image">
                                            <Image src="/images/logo-design.svg" alt="Web" width="100%" />
                                        </div>
                                        <div className="footer__top__info__content__item media__title">
                                            <h5><a href="#services">Logo &amp; Creatives Design</a></h5>
                                            <p>Showcase your brand with the help of our creative designers.</p>
                                        </div>
                                    </div>
                                    <div className="footer__top__info__content__item media">
                                        <div className="footer__top__info__content__item media__image">
                                            <Image src="/images/marketing.svg" alt="Web" width="100%" />
                                        </div>
                                        <div className="footer__top__info__content__item media__title">
                                            <h5><a href="#services">Digital Marketing</a></h5>
                            ...
                            <Col lg="3" sm="12">
                                ...
                                <div className="footer__top__info__content">
                                    <a href="https://www.facebook.com/foxcode.tech" target="__blank" className="footer__top__info__content__social">
                                    ...
                                    <a href="#footer" target="__blank" className="footer__top__info__content__social">
                        ...
                        <Row>
                            <Col lg="12" sm="12">
                                <span className="footer__bottom__copyright">
                                    Fox Code &#9400; Copyright 2019. All rights reserved.
                                </span>
                            </Col>
                        </Row>
                    </Container>
